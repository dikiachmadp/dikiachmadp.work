      ...
      <div className="main-container">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 mb-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              {/* Ukuran dinamis untuk Title Top */}
              <span
              ...
              {/* Ukuran dinamis untuk Title Bottom (Aksen) */}
              <span
            ...
            <div className="max-w-xl space-y-8">
              {/* Ukuran dinamis untuk Deskripsi */}
              <p
        ...
        {/* 4. Statistik Performa menggunakan StatBox */}
        {/* Catatan: Di dalam StatBox, pastikan value-nya menggunakan var(--text-stats-num) */}
        <div
